...
export const I18N = {
  en: {
    ...
    newChat: "New chat",
    send: "Send",
    placeholder: "Ask anything…  @repo/@document or #symbol to narrow scope · Enter to send",
    tip: "Tip: type <b>@</b> to focus on one app or document, <b>#</b> to focus on a specific feature/screen.",
  ...
  vi: {
    ...
    send: "Gửi",
    placeholder: "Hỏi bất cứ điều gì…  @repo/@tài-liệu hoặc #symbol để thu hẹp phạm vi · Enter để gửi",
    tip: "Mẹo: gõ <b>@</b> để tập trung vào một ứng dụng hoặc tài liệu, <b>#</b> để tập trung vào một tính năng/màn hình cụ thể.",
